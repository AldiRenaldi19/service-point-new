...
{{-- Menambahkan style khusus untuk menghandle konten render dari RichEditor --}}
@push('styles')
<style>
    .rich-content img {
        max-width: 100%;
...
<div class="bg-slate-50 min-h-screen pt-32 pb-20 px-4">
    <div class="max-w-7xl mx-auto">
        ...
        {{-- ==========================================
             ...
             Navigasi petunjuk posisi halaman aktif.
             ========================================== --}}
        ...
        {{-- Grid Konten Utama (Gambar vs Detail Info) --}}
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            
            {{-- ==========================================
                 2. IMAGE DISPLAY SECTION
                 Menampilkan visual utama produk (Sticky).
                 ========================================== --}}
            ...
            {{-- ==========================================
                 ...
                 Kumpulan data teks, spesifikasi, dan tombol aksi.
                 ========================================== --}}
            <div class="space-y-8">
                ...
                <div class="text-left">
                    ...
                    {{-- Badge Informasi Brand Manufaktur --}}
                    @if($product->brand)
                ...
                {{-- Panel Deskripsi Detail & Spesifikasi Teknis --}}
                <div class="bg-blue-950 rounded-[3rem] p-8 md:p-10 text-white relative overflow-hidden text-left">
                    ...
                    <div class="relative z-10">
                        ...
                        {{-- Section Pembatas Spesifikasi Fisik/Teknis Produk --}}
                ...
                {{-- ==========================================
                     4. ACTION BUTTONS
                     Akses navigasi kembali dan pemesanan WhatsApp.
                     ========================================== --}}
