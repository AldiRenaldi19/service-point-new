...
@section('content')
    {{-- 1. Header / Hero Section (EXISTING) --}}
    <header class="relative bg-blue-950 py-20 md:py-32 px-4 overflow-hidden">
        <div class="max-w-7xl mx-auto relative z-10">
            <div class="text-center">
                ...
                <h1 class="text-5xl md:text-8xl font-black text-white leading-none tracking-tighter">
                    SERVICE POINT <br> <span class="text-amber-400 italic font-serif">TRUST & PRECISION.</span>
                </h1>
    ...
    {{-- 2. Stats Section (NEW - Kelihatan Pro) --}}
    ...
    {{-- 3. Vision & Core Values Section (EXISTING - REFINED) --}}
    <section class="py-24 bg-white px-4">
        <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center">
            <div class="relative reveal">
                <div class="absolute -inset-4 bg-slate-100 rounded-[3rem] -z-10 rotate-3"></div>
            ...
            <div class="reveal">
                <h2 class="text-4xl md:text-6xl font-black text-blue-950 uppercase italic tracking-tighter leading-none mb-8">
                    Visi Kami <br> <span class="text-blue-700 underline decoration-amber-400">Menjadi Standar.</span>
                </h2>
                <div class="space-y-8">
    ...
    {{-- 4. Mission Statement (NEW - Info Lebih Lengkap) --}}
        ...
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 items-center">
            <div class="md:w-1/2 reveal">
                <h2 class="text-white text-4xl md:text-5xl font-black uppercase italic tracking-tighter leading-none mb-8">
                    Misi Kami Untuk <br> <span class="text-amber-400">Dunia Otomotif.</span>
                </h2>
                <ul class="space-y-6">
            ...
            <div class="md:w-1/2 grid grid-cols-2 gap-4 reveal" style="transition-delay: 0.2s;">
                <video autoplay muted loop playsinline class="rounded-3xl h-64 w-full object-cover" alt="Service 1">
                    <source src="{{ asset('assets/vid/product.mp4') }}" type="video/mp4">
                </video>
                <video autoplay muted loop playsinline class="rounded-3xl h-64 w-full object-cover mt-8" alt="Service 2">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6 reveal">
                <div>
                    ...
                    <p class="text-slate-500 mt-4 max-w-sm">Dedikasi kami tercermin dari kepuasan ribuan pelanggan di Jatiasih dan sekitarnya.</p>
                </div>
    ...
    {{-- 6. Academic Collaboration Section (EXISTING & BRIGHT PHOTO) --}}
    <section class="py-24 bg-white px-4">
        <div class="max-w-7xl mx-auto">
                ...
                <div class="grid md:grid-cols-2 items-center">
                    <div class="p-12 md:p-20 reveal">
                        ...
                        <h2 class="text-4xl md:text-5xl font-black text-white uppercase italic tracking-tighter mt-4 leading-none">
                            Powered by <br> <span class="text-blue-400">Universitas Pelita Bangsa.</span>
                        </h2>
                        <p class="text-blue-100 mt-6 leading-relaxed italic text-sm md:text-base">
                            Platform digital ini merupakan hasil kolaborasi inovatif dan didukung oleh mahasiswa Teknik Informatika Universitas Pelita Bangsa untuk memodernisasi layanan otomotif di Indonesia melaui automasi sistem informasi.
                        </p>
                    ...
                    <div class="relative h-[400px] md:h-[600px] overflow-hidden reveal" style="transition-delay: 0.2s;">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-r from-blue-950/40 to-transparent md:block hidden"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-4xl mx-auto bg-blue-950 p-12 md:p-20 rounded-[4rem] relative overflow-hidden shadow-2xl reveal">
            <div class="relative z-10">
                <h2 class="text-4xl md:text-6xl font-black text-white uppercase italic tracking-tighter leading-tight mb-8">
                    Siap Berikan Yang <br> <span class="text-amber-400">Terbaik</span> Untuk Mobil Anda?
                </h2>
